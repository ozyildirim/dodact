...
class _AnimatedBottomBar extends State<AnimatedBottomBar>
  ...
  void initState() {
    super.initState();
    _controllerButtonsChanging =
        AnimationController(vsync: this, duration: Duration(milliseconds: 200));
    _controllerFloatButtonDropIn =
        AnimationController(vsync: this, duration: Duration(milliseconds: 100));
    _controllerFloatButtonDropOut =
        AnimationController(vsync: this, duration: Duration(milliseconds: 200));
    _controllerContainerDropIn =
        AnimationController(vsync: this, duration: Duration(milliseconds: 100));
    _controllerContainerDropOut =
    ...
    return new GestureDetector(
        child: new Card(
            ...
            margin: EdgeInsets.only(
                bottom: _animationMargin[correspondMargin % 2].value),
  ...
  Widget build(BuildContext context) {
    ...
    _animationBorder = new Tween<double>(begin: 0.0, end: widgetScreen)
